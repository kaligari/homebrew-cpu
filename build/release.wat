(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 42004))
 (memory $0 1)
 ...
 (data $30 (i32.const 9184) "\0c\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 ")
 (data $30.1 (i32.const 9220) "\02A\00\00\00\00\00\00\02\t\00\00\a4")
 ...
 (func $assembly/models/Memory/Memory#getMemory (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
 ...
 (func $assembly/models/Memory/Memory#get:length (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
     ...
     block $__inlined_func$assembly/models/Register/Register8bit#beforeTick@override
      block $default
       ...
       if
        ...
        i32.const 7
        i32.eq
        br_if $__inlined_func$assembly/models/Register/Register8bit#beforeTick@override
        br $default
       end
       local.get $3
